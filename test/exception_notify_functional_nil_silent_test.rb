...
class ExceptionNotifyFunctionalNilSilentTest < ActionController::TestCase
  tests NilSilentExceptions
  ...
  def setup
    ...
    ActionMailer::Base.class_eval do
      def deliver!(mail = @mail)
        ExceptionNotifyFunctionalNilSilentTest.delivered_mail << mail
      end
    end
  end

  def teardown
    ExceptionNotifyFunctionalNilSilentTest.delivered_mail = []
    ActionController::Base.consider_all_requests_local = false
  end
