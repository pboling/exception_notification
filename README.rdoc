...
The Exception Notifier gem provides a mailer object and a default set of
...
This gem was originally called Super Exception Notifier and was (initially) based on
svn v8821 of the wonderful exception_notification gem, and remains for
the most part a drop in replacement with greatly extended functionality and 
customization options.  Since then it has kept up with the work on the core team's branch.
